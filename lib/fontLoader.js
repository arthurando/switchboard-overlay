...
const FONT_FILES = ['elle-bold.ttf', 'NotoSansTC.ttf', 'MElle-HK-Xbold.ttf'];
...
<fontconfig>
  ...
  <!-- Match "MElle HK Xbold" family -->
  <match target="pattern">
    <test name="family"><string>MElle HK Xbold</string></test>
    <edit name="family" mode="prepend" binding="strong">
      <string>MElle HK Xbold</string>
    </edit>
  </match>

  <!-- CJK fallback for MElle HK Xbold: append Noto Sans TC -->
  <match target="pattern">
    <test name="family"><string>MElle HK Xbold</string></test>
    <edit name="family" mode="append" binding="weak">
      <string>Noto Sans TC</string>
