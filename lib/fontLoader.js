...
<fontconfig>
  ...
  <!-- CJK fallback: append Noto Sans TC Thin when Elle cannot render characters -->
  <!-- IMPORTANT: Must use "Noto Sans TC Thin" - the actual internal family name of NotoSansTC.ttf -->
  <match target="pattern">
    <test name="family"><string>Elle</string></test>
    <edit name="family" mode="append" binding="weak">
      <string>Noto Sans TC Thin</string>
    </edit>
  </match>
  ...
  <!-- Default sans-serif fallback to Noto Sans TC Thin -->
  <match target="pattern">
  ...
  <!-- Global fallback: any unresolved font gets Noto Sans TC Thin -->
  <match target="pattern">
