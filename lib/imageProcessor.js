...
async function generateTextOverlay(text, canvasWidth = 1080, canvasHeight = 1080) {
  ...
  // Use fontfile for direct font loading (bypasses fontconfig entirely)
  ...
  if (fsSync.existsSync(primaryFontFile)) {
    ...
    console.log(`[textOverlay] ⚠️ fontfile not found: ${primaryFontFile}, falling back to fontconfig`);
  }
